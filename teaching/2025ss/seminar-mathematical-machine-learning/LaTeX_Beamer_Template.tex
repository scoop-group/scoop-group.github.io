...
% Set talk information.
\title[SHORT TITLE]{FULL TITLE}
\author{AUTHOR, AUTHOR}
\date[DATE]{Seminar Mathematical Machine Learning \\ Winter Semester 2023}
...
\begin{frame}
  \frametitle{A Slide in the Second Section}
  \begin{block}{An image created using \texttt{tikz}}
